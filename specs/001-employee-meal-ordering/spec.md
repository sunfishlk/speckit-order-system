...
- **菜品价格变动**：员工加入购物车后，菜品价格更新（如供应商调价），购物车价格如何处理？[NEEDS CLARIFICATION: 是按加入时价格锁定，还是提交时按最新价格计算？]
